...
define([
  ...
  function (
    ...
    page1ToPage2 : function() {
      ...
      if (this.selectByShape.checked === false && this.selectByFeature.checked === false && this.selectByFeatureQuery.checked === false) {
    ...
    showPage1 : function() {
      ...
      if ( typeof (this.config.selectByShape) === 'undefined' && typeof (this.config.selectByFeature) === 'undefined' && typeof (this.config.selectByFeatureQuery) === 'undefined') {
